...
//	private JButton btnEvaluation = new JButton("评价");
	private JButton btnDeleteRecipe = new JButton("删除菜谱");
...
//	菜谱
	...
	public BeanRecipeInformation curRecipes = null;
...
//		curRecipes = allRecipes.get(recipe_number);
	...
	public FrmAllRecipeAdmin(JFrame f, String s, boolean b) {
...
//		鼠标点击 刷新界面 菜谱
		this.dataTableRecipes.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int i = FrmAllRecipeAdmin.this.dataTableRecipes.getSelectedRow();
				if (i < 0) {
					return;
				}
				...
				FrmAllRecipeAdmin.this.reloadTable();
				FrmAllRecipeAdmin.this.reloadStepsTable(i);
				FrmAllRecipeAdmin.this.reloadMaterialsTable(i);
				FrmAllRecipeAdmin.this.reloadEvaluationsTable(i);
			}
...
//		鼠标点击 刷新界面 评价 , 点击评价, 浏览+1
		this.dataTableEvaluations.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				int i = FrmAllRecipeAdmin.this.dataTableEvaluations.getSelectedRow();
				if (i < 0) {
					return;
				}
